...
Please open an [issue](https://github.com/ArhanCodes/tinfoil/issues/new) with any bug reports, or a [pull request](https://github.com/ArhanCodes/tinfoil/compare) to merge something you worked on.
